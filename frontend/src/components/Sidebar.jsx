export default function Sidebar({ onSelectPage }) {
    return (
        <div className="bg-black rounded-full w-11 flex flex-col items-center gap-4 px-2 py-48 justify-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512"
                 onClick={() => onSelectPage("VehicleStatusPage")}>
                <path fill="white" 
                      d="M80 224l37.78-88.15C123.93 121.5 139.6 112 157.11 112h197.78c17.51 0 33.18 9.5 39.33 23.85L432 224M80 224h352M80 224v144c0 17.67 14.33 32 32 32h16c17.67 0 32-14.33 32-32v-32h192v32c0 17.67 14.33 32 32 32h16c17.67 0 32-14.33 32-32V224M144 288h16M352 288h16"/>
            </svg>
